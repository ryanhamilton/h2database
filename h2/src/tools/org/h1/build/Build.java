...
import org.h1.build.doc.XMLParser;
...
public class Build extends BuildBase {
    ...
    public void benchmark() {
        ...
        StringList args = args("-Xmx128m",
                "-cp", cp, "org.h1.test.bench.TestPerformance");
    ...
    private void compileTools() {
        mkdir("temp");
        FileList files = files("src/tools").keep("src/tools/org/h1/build/*");
    ...
    public void coverage() {
        ...
        execJava(args(
                ...
                "-javaagent:ext/jacocoagent.jar=destfile=coverage/jacoco.exec,"
                        + "excludes=org.h1.test.*:org.h1.tools.*:org.h1.sample.*",
                "-cp", cp,
                "org.h1.test.TestAll", "codeCoverage"));
        // Remove classes that we don't want to include in report
        delete(files("coverage/bin/org/h1/test"));
        delete(files("coverage/bin/org/h1/tools"));
        delete(files("coverage/bin/org/h1/sample"));
        // Generate report
        execJava(args("-cp",
    ...
    private void compileMVStore(boolean debugInfo) {
        ...
        FileList files;
        files = files("src/main/org/h1/mvstore").
                exclude("src/main/org/h1/mvstore/db/*");
    ...
    private void compile(boolean debugInfo, boolean clientOnly,
        ...
        FileList files;
        if (clientOnly) {
            files = files("src/main/org/h1/Driver.java");
            files.addAll(files("src/main/org/h1/jdbc"));
            files.addAll(files("src/main/org/h1/jdbcx"));
        } else {
        ...
        if (!clientOnly) {
            ...
            files = files.exclude("src/test/org/h1/test/TestAllJunit.java");
    ...
    public void docs() {
        ...
        java("org.h1.build.doc.XMLChecker", null);
        java("org.h1.build.code.CheckJavadoc", null);
        java("org.h1.build.code.CheckTextFiles", null);
        java("org.h1.build.doc.GenerateDoc", null);
        java("org.h1.build.doc.GenerateHelp", null);
        java("org.h1.build.indexer.Indexer", null);
        java("org.h1.build.doc.MergeDocs", null);
        java("org.h1.build.doc.WebSite", null);
        java("org.h1.build.doc.LinkChecker", null);
        java("org.h1.build.doc.XMLChecker", null);
        java("org.h1.build.doc.SpellChecker", null);
        java("org.h1.build.code.CheckTextFiles", null);
        beep();
    }
    ...
    private static String getVersion() {
        return getStaticField("org.h1.engine.Constants", "VERSION");
    }
    ...
    public void installer() {
        ...
        String buildDate = getStaticField("org.h1.engine.Constants", "BUILD_DATE");
    ...
    private void addVersions(boolean includeCurrentTimestamp, boolean addNetUtils) {
        ...
        if (!includeCurrentTimestamp) {
            delete(files("temp/META-INF/versions/9/org/h1/util/CurrentTimestamp.class"));
        }
        if (addNetUtils) {
    ...
    public void jar() {
        ...
        FileList files = files("temp").
            exclude("temp/org/h1/build/*").
            exclude("temp/org/h1/dev/*").
            exclude("temp/org/h1/jcr/*").
            exclude("temp/org/h1/java/*").
            exclude("temp/org/h1/jcr/*").
            exclude("temp/org/h1/samples/*").
            exclude("temp/org/h1/server/ftp/*").
            exclude("temp/org/h1/test/*").
            exclude("*.bat").
            exclude("*.sh").
            exclude("*.txt").
            exclude("*.DS_Store");
    ...
    public void jarSmall() {
        ...
        FileList files = files("temp").
            ...
            exclude("temp/org/h1/server/ftp/*").
            exclude("temp/org/h1/test/*").
            exclude("temp/org/h1/bnf/*").
            exclude("temp/org/h1/fulltext/*").
            exclude("temp/org/h1/jdbcx/*").
            exclude("temp/org/h1/jmx/*").
            exclude("temp/org/h1/server/*").
            exclude("temp/org/h1/tools/*").
            exclude("*.bat").
            exclude("*.sh").
            exclude("*.txt").
            exclude("*.DS_Store");
        files = excludeTestMetaInfFiles(files);
        files.add(new File("temp/org/h1/tools/DeleteDbFiles.class"));
        files.add(new File("temp/org/h1/tools/CompressTool.class"));
    ...
    public void javadoc() {
        ...
        delete("docs");
        mkdir("docs/javadoc");
        javadoc("-sourcepath", "src/main", "org.h1.jdbc", "org.h1.jdbcx",
                "org.h1.tools", "org.h1.api", "org.h1.engine", "org.h1.fulltext",
                "-classpath",
                ...
                "-doclet", "org.h1.build.doclet.Doclet");
    ...
    public void javadocImpl() {
        ...
        javadoc("-sourcepath", "src/main",
                ...
                File.pathSeparator + "ext/org.osgi.enterprise-4.2.0.jar" +
                File.pathSeparator + "ext/jts-core-1.15.0.jar",
                "-subpackages", "org.h1.mvstore",
                "-exclude", "org.h1.mvstore.db");
    ...
    public void mavenDeployCentral() {
        ...
        files = files("src/main");
        copy("docs", files, "src/main");
        files = files("docs").keep("docs/org/h1/mvstore/*").
                exclude("docs/org/h1/mvstore/db/*").
                keep("*.java");
        files.addAll(files("docs").keep("docs/META-INF/*"));
    ...
    private void resources(boolean clientOnly, boolean basicOnly) {
        if (!clientOnly) {
            //java("org.h1.build.doc.GenerateHelp", null);
            //javadoc("-sourcepath", "src/main", "org.h1.tools", "org.h1.jmx",
//                    "-classpath",
//                    "ext/lucene-core-5.5.5.jar" +
//                    File.pathSeparator + "ext/lucene-analyzers-common-5.5.5.jar" +
//                    File.pathSeparator + "ext/lucene-queryparser-5.5.5.jar" +
//                    File.pathSeparator + "ext/jts-core-1.15.0.jar",
//                    "-docletpath", "bin" + File.pathSeparator + "temp",
//                    "-doclet", "org.h1.build.doclet.ResourceDoclet");
        }
        FileList files = files("src/main").
            exclude("*.MF").
            exclude("*.java").
            ...
            exclude("*.DS_Store");
        if (basicOnly) {
            files = files.keep("src/main/org/h1/res/_messages_en.*");
        }
        if (clientOnly) {
            files = files.exclude("src/main/org/h1/res/help.csv");
            files = files.exclude("src/main/org/h1/res/h2*");
            files = files.exclude("src/main/org/h1/res/javadoc.properties");
            files = files.exclude("src/main/org/h1/server/*");
        }
        zip("temp/org/h1/util/data.zip", files, "src/main", true, false);
    }
