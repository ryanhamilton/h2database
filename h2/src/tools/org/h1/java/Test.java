...
public class Test extends TestBase {
    ...
    public void test() throws IOException {
        ...
        parser.parse("src/tools/org/h1", "java.lang.Object");
        parser.parse("src/tools/org/h1", "java.lang.String");
        parser.parse("src/tools/org/h1", "java.lang.Math");
        parser.parse("src/tools/org/h1", "java.lang.Integer");
        parser.parse("src/tools/org/h1", "java.lang.Long");
        parser.parse("src/tools/org/h1", "java.lang.StringBuilder");
        parser.parse("src/tools/org/h1", "java.io.PrintStream");
        parser.parse("src/tools/org/h1", "java.lang.System");
        parser.parse("src/tools/org/h1", "java.util.Arrays");
        parser.parse("src/tools", "org.h1.java.TestApp");
