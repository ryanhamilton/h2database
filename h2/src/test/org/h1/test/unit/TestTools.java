...
import org.h1.tools.SimpleResultSet.SimpleArray;
...
import org.h1.test.trace.Player;
import org.h1.test.utils.AssertThrows;
...
public class TestTools extends TestDb {
    ...
    private void testJdbcDriverUtils() {
        assertEquals("org.h1.Driver", JdbcUtils.getDriver("jdbc:h2:~/test"));
        ...
        try {
            JdbcUtils.getConnection("org.h1.Driver", "jdbc:h2x:test", "sa", "");
