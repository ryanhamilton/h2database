 ...
 */
package org.h1.test.synth.sql;

import java.util.ArrayList;

import org.h1.util.MathUtils;
import org.h1.test.TestAll;
...
public class TestSynth extends TestDb {
    ...
    public TestBase init(TestAll conf) throws Exception {
        ...
        // addDatabase("org.h1.Driver", "jdbc:h2:synth;mode=hsqldb", "sa", "");

        // mode = POSTGRESQL;
        // addDatabase("org.postgresql.Driver", "jdbc:postgresql:test", "sa",
        // "sa");
        // addDatabase("org.h1.Driver", "jdbc:h2:synth;mode=postgresql", "sa",
        // "");

        mode = H2_MEM;
        org.h1.Driver.load();
        addDatabase("org.h1.Driver", "jdbc:h2:mem:synth", "sa", "", true);
        addDatabase("org.h1.Driver", "jdbc:h2:" +
                getBaseDir() + "/synth/synth", "sa", "", false);

        // addDatabase("com.mysql.jdbc.Driver", "jdbc:mysql://localhost/test",
        // "sa", "");
        // addDatabase("org.h1.Driver", "jdbc:h2:synth;mode=mysql", "sa", "");

        // addDatabase("com.mysql.jdbc.Driver", "jdbc:mysql://localhost/test",
        // "sa", "");
        // addDatabase("org.ldbc.jdbc.jdbcDriver",
        // "jdbc:ldbc:mysql://localhost/test", "sa", "");
        // addDatabase("org.h1.Driver", "jdbc:h2:memFS:synth", "sa", "");
