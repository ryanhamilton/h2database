 ...
 */
package org.h1.expression.function;

import static org.h1.expression.function.Function.CENTURY;
import static org.h1.expression.function.Function.DAY_OF_MONTH;
import static org.h1.expression.function.Function.DAY_OF_WEEK;
import static org.h1.expression.function.Function.DAY_OF_YEAR;
import static org.h1.expression.function.Function.DECADE;
import static org.h1.expression.function.Function.DOW;
import static org.h1.expression.function.Function.EPOCH;
import static org.h1.expression.function.Function.HOUR;
import static org.h1.expression.function.Function.ISO_DAY_OF_WEEK;
import static org.h1.expression.function.Function.ISO_WEEK;
import static org.h1.expression.function.Function.ISO_YEAR;
import static org.h1.expression.function.Function.MICROSECOND;
import static org.h1.expression.function.Function.MILLENNIUM;
import static org.h1.expression.function.Function.MILLISECOND;
import static org.h1.expression.function.Function.MINUTE;
import static org.h1.expression.function.Function.MONTH;
import static org.h1.expression.function.Function.NANOSECOND;
import static org.h1.expression.function.Function.QUARTER;
import static org.h1.expression.function.Function.SECOND;
import static org.h1.expression.function.Function.TIMEZONE_HOUR;
import static org.h1.expression.function.Function.TIMEZONE_MINUTE;
import static org.h1.expression.function.Function.TIMEZONE_SECOND;
import static org.h1.expression.function.Function.WEEK;
import static org.h1.expression.function.Function.YEAR;
import static org.h1.util.DateTimeUtils.MILLIS_PER_DAY;
import static org.h1.util.DateTimeUtils.NANOS_PER_DAY;
import static org.h1.util.DateTimeUtils.NANOS_PER_HOUR;
import static org.h1.util.DateTimeUtils.NANOS_PER_MINUTE;
