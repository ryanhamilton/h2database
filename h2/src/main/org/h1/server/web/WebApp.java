...
import org.h1.bnf.Bnf;
import org.h1.bnf.context.DbColumn;
import org.h1.bnf.context.DbContents;
import org.h1.bnf.context.DbSchema;
import org.h1.bnf.context.DbTableOrView;
import org.h1.command.Parser;
import org.h1.engine.Constants;
import org.h1.engine.SysProperties;
import org.h1.jdbc.JdbcException;
import org.h1.message.DbException;
import org.h1.security.SHA256;
import org.h1.tools.Backup;
import org.h1.tools.ChangeFileEncryption;
import org.h1.tools.ConvertTraceFile;
import org.h1.tools.CreateCluster;
import org.h1.tools.DeleteDbFiles;
import org.h1.tools.Recover;
import org.h1.tools.Restore;
import org.h1.tools.RunScript;
import org.h1.tools.Script;
import org.h1.tools.SimpleResultSet;
...
import org.h1.util.ScriptReader;
import org.h1.util.SortedProperties;
...
public class WebApp {
            ...
            if (e instanceof SQLException) {
                ...
                if (isH2) {
                    ...
                    error += " <a href=\"https://h2database.com/javadoc/" +
                            "org/h1/api/ErrorCode.html#c" + code +
                            "\">(${text.a.help})</a>";
                }
            }
    ...
    private static String linkToSource(String s) {
        try {
            ...
            while (true) {
                int start = s.indexOf("org.h1.", idx);
                if (start < 0) {
