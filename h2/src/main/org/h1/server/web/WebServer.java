...
import org.h1.server.Service;
import org.h1.server.ShutdownHandler;
...
public class WebServer implements Service {
    ...
    private static final String[] GENERIC = {
        ...
        "Generic H2 (Server)|org.h1.Driver|" +
                "jdbc:h2:tcp://localhost/~/test|sa",
        // this will be listed on top for new installations
        "Generic H2 (Embedded)|org.h1.Driver|" +
                "jdbc:h2:~/test|sa",
    };
...
//    }
    ...
    byte[] getFile(String file) throws IOException {
        trace("getFile <" + file + ">");
        byte[] data = Utils.getResource("/org/h1/server/web/res/" + file);
        if (data == null) {
            trace(" null");
        } else {
