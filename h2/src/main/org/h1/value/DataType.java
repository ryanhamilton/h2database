...
import org.h1.api.Interval;
import org.h1.api.IntervalQualifier;
import org.h1.api.TimestampWithTimeZone;
import org.h1.engine.Mode;
import org.h1.engine.SessionInterface;
import org.h1.engine.SysProperties;
import org.h1.jdbc.JdbcArray;
import org.h1.jdbc.JdbcBlob;
import org.h1.jdbc.JdbcClob;
import org.h1.jdbc.JdbcConnection;
import org.h1.jdbc.JdbcLob;
    ...
    public static Value readValue(SessionInterface session, ResultSet rs, int columnIndex, int type) {
        try {
            ...
            case Value.TIME_TZ: {
                if (JSR310.PRESENT) {
                    try {
                        Object value = rs.getObject(columnIndex, JSR310.OFFSET_TIME);
    ...
    public static String getTypeClassName(int type, boolean forResultSet) {
        ...
        case Value.TIME_TZ:
            if (JSR310.PRESENT) {
                ...
                return JSR310.OFFSET_TIME.getName();
            }
            // "java.lang.String";
        ...
        case Value.TIMESTAMP_TZ:
            ...
            // "org.h1.api.TimestampWithTimeZone";
...
//            return Value.CLOB;
            ...
            return Value.TIME;
        } else if (JSR310.OFFSET_TIME == x) {
            return Value.TIME_TZ;
        } else if (JSR310.LOCAL_DATE_TIME == x) {
            return Value.TIMESTAMP;
        } else if (JSR310.OFFSET_DATE_TIME == x || JSR310.ZONED_DATE_TIME == x || JSR310.INSTANT == x) {
            return Value.TIMESTAMP_TZ;
        } else {
            if (JdbcUtils.customDataTypesHandler != null) {
